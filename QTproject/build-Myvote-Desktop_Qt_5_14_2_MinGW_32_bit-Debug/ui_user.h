...
public:
    ...
    void setupUi(QWidget *user)
    {
        ...
        widget->setGeometry(QRect(440, 310, 101, 171));
        ...
        changenamebtn = new QPushButton(widget);
        ...
        widget1 = new QWidget(user);
        widget1->setObjectName(QString::fromUtf8("widget1"));
        widget1->setGeometry(QRect(0, 0, 581, 83));
        ...
        activityName = new QLabel(widget1);
