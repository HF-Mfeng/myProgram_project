...
#include <memory>
#include "../../Myvote/administrator.h"
...
QT_MOC_LITERAL(1, 14, 8), // "backMain"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 12) // "changeMyCode"

    },
    "administrator\0backMain\0\0changeMyCode"
};
...
void administrator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->changeMyCode(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (administrator::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&administrator::backMain)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (administrator::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&administrator::changeMyCode)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject administrator::staticMetaObject = { {
    ...
    qt_meta_stringdata_administrator.data,
...
// SIGNAL 0
void administrator::backMain()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void administrator::changeMyCode()
{
