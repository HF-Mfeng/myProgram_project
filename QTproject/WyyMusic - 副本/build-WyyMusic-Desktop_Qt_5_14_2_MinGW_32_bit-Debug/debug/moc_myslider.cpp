...
QT_MOC_LITERAL(1, 9, 14), // "mySliderChange"
QT_MOC_LITERAL(2, 24, 0) // ""

    },
    "MySlider\0mySliderChange\0"
};
...
void MySlider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->mySliderChange(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MySlider::mySliderChange)) {
                *result = 0;
                return;
            }
        }
